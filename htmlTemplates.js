    ...
    <strong>ไม่พบข้อมูล!</strong>
            ...
            <div class="top">
                ...
                <div class="inputsearch">
                    <form action="/display" method="post"  style="display: flex;">
                
                        <input type="text" class="form-control insearch"id="keyword" name="keyword" placeholder="เติม '/'หน้าตัวอักษรเพื่อค้นหาทั้งหมด" >
                        <button class="butsearch" style="border-radius: 2em;" type="submit">Search</button>
                    </form>
                </div>
            </div>
...
const nore = `<!DOCTYPE html>
 ...
 <body>
     ...
     <div class="focus">
         ...
         <div>
             <div class="img"><img width="15%" src="/img/logoP.png" id="logoPP" alt=""></div>
             <div class="content ">
                 ...
                 <div>
                     ...
                     <div class="inputsearch">
                         <form action="/displayOne" method="post">
                            <input style = 'margin: auto;' type="text" class="form-control insearch"id="keyword" name="keyword" placeholder="เติม '/'หน้าตัวอักษรเพื่อค้นหาทั้งหมด" >
...
module.exports = { noResultHtml, resultHtml, nore };