...
<body>
    ...
    <center>
        <div>
            <h1 style="margin-top: 1.5em; font-family:'Kanit', sans-serif ;">แก้ไขข้อมูลพรรณไม้</h1>
        </div>
    </center>
    ...
    <strong>ไม่พบข้อมูล!</strong>
            ...
            <div class="top">
                ...
                <div class="inputsearch">
                    <form action="/displayup" method="post" style="display: flex;">
                    <input type="text" class="form-control insearch"id="keyword" name="keyword" placeholder="ค้นหาข้อมูลพรรณไม้" >
    ...
    data.forEach((record, index) => {
        htmlResponse += `<tr onclick="redirectToDetails('${record['_id']}')">
                          ...
                          <td data-label="ชื่อไทย">${record['Name']['TH']}</td>
                          <td data-label="ชื่ออื่น">${record['OtherName']['TH']}</td>
...
function redirectToDetails(id) {
    ...
    window.location.href = '/update?id=' + encodeURIComponent(id);
  }
...
<body>
    ...
    <div>
            <h1 style="margin-top: 1.5em; font-family:'Kanit', sans-serif ;text-align:center">แก้ไขข้อมูลพรรณไม้</h1>
    </div>
 ...
 <form action="/displayup" method="post" style="display: flex;">
<!-- <input class="insearch" type="text" id="keyword" name="keyword"
    placeholder="ค้นหาตัวอย่างพรรณไม้"> -->
...
module.exports = { noResultHtmlup, resultHtmlUp };